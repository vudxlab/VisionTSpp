...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_path', type=str, default="ckpt.ckpt")
    parser.add_argument('--save_name', type=str, default="ltsf_96.csv")
    
    parser.add_argument('--quantile', type=int, default=1)
    parser.add_argument('--clip_input', type=int, default=0)
    parser.add_argument('--complete_no_clip', type=int, default=0)
    
    # ! 250605 adds:增加可视化？
    parser.add_argument('--visual', type=int, default=0)
    parser.add_argument('--LOOKBACK_LEN_VISUAL', type=int, default=300)
    
    # ! 250429 adds:
    parser.add_argument('--color', type=int, default=0)
    parser.add_argument('--num_patch_input', type=int, default=7)
    ...
    if args.task_name == 'long_term_forecast':
        ...
        # # 250322 adds
        # from exp.exp_long_term_forecasting_emsemble import Exp_Long_Term_Forecast_emsemble
        # Exp = Exp_Long_Term_Forecast_emsemble
