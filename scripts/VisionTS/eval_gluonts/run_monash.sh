...
do
  python run.py --dataset=${ds} --save_name=${1}_monash.csv --periodicity=autotune --context_len=1000 --no_periodicity_context_len=300 --batch_size 128 --checkpoint_path=${1} --num_patch_input=${2}
