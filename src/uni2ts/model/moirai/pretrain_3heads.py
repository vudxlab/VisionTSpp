...
class MoiraiPretrain(L.LightningModule):
    ...
    def visualization(self, x, y, y_pred, input_image, reconstructed_image, cur_periodicity, cur_context_len, cur_pred_len, cur_nvars=1, cur_color_list=None, y_pred_std=None, y_pred_25=None, y_pred_75=None):
    ...
    def forward_module(self, module, target, nvars, color_list):
        ...
        if self.hparams.output_dist == 'quantile':
            ...
            y_grey_25 = process_images(image_25_reconstructed, nvars, color_list) # [B, 1, H=224, W=224]
            y_grey_75 = process_images(image_75_reconstructed, nvars, color_list) # [B, 1, H, W]
    ...
    def forward(
        ...
        if not self.hparams.output_dist == 'quantile':
            mask, y_logvar, image_reconstructed, y_grey, y_pred_img = self.forward_module(self.module, target, nvars, color_list)
        else:
            mask, y_logvar, image_reconstructed, y_grey, y_pred_img, y_grey_25, y_pred_img_25, y_grey_75, y_pred_img_75 = self.forward_module(self.module, target, nvars, color_list)
